"""
Module containing general utilities needed for the analysis.
...
def interpolate_map(
    ...
    """
    Determine a spatial map from measurements through interpolation.

    Arguments:
         measurements (tuple[np.ndarray, ...]): tuple of x, y, and
            data measurements, providing the input for interpolation.
